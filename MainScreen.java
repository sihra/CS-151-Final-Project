...
public class MainScreen extends JFrame implements ViewInterface, WindowListener{
	...
	public void windowClosing(WindowEvent e) {
		...
		{
		int result = JOptionPane.showConfirmDialog(this, "You are about to close the application, any unsaved work will be lost.\n Are you sure you would like to continue?", null, JOptionPane.OK_CANCEL_OPTION);
		switch(result)
		{
