...
public class TaskView extends JFrame implements ViewInterface {
	...
	public TaskView(TaskModel _data, boolean editMode, ProjectController _parent) {
		...
		// Have seperate text fields to make it easier to change in view class and translate to model/controller classes
		...
		statusChange.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        parent.transferTask(data, name); // Automatically updates views for Project through ProjectModel's notifyViews() method
			}
		});
